                                ...
                                <li class="nav-item dropdown notification">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <div class="notification-list">
                                            <div class="media new">
                                                <div class="img-user"><img src="{{URL::to('assets/dist/img/avatar.png')}}" alt=""></div>
                                            ...
                                            <div class="media new">
                                                <div class="img-user online"><img src="{{URL::to('assets/dist/img/avatar2.png')}}" alt=""></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="img-user"><img src="{{URL::to('assets/dist/img/avatar3.png')}}" alt=""></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="img-user"><img src="{{URL::to('assets/dist/img/avatar4.png')}}" alt=""></div>
                                                <div class="media-body">
                                ...
                                <li class="nav-item dropdown user-menu">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" >
                                        ...
                                        <div class="user-header">
                                            ...
                                            <h6>Naeem Khan</h6>
                                            <span><a href="cdn-cgi/l/email-protection.html" class="__cf_email__" data-cfemail="52372a333f223e3712353f333b3e7c313d3f">[email&#160;protected]</a></span>
                                        </div><!-- user-header -->
