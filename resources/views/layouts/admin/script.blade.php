 <!--Global script(used by all pages)-->
        <script data-cfasync="false" src="{{URL::to('cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script><script src="{{URL::to('assets/plugins/jQuery/jquery-3.4.1.min.js')}}"></script>
